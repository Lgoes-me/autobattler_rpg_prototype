...
public class Blit : ScriptableRendererFeature {
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        Src = (settings.srcType == Target.CameraColor) ? renderer.cameraColorTargetHandle : srcIdentifier;
        Dest = (settings.dstType == Target.CameraColor) ? renderer.cameraColorTargetHandle : dstIdentifier;

    }

    public RenderTargetIdentifier Src { get; set; }
    public RenderTargetIdentifier Dest { get; set; }
